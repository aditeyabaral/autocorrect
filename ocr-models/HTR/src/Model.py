...
class Model:
    ...
    def __init__(
        self, charList, decoderType=DecoderType.BestPath, mustRestore=False, dump=False
    ):
        ...
        self.inputImgs = tf.compat.v1.placeholder(
            tf.float32, shape=(None, Model.imgSize[0], Model.imgSize[1])
        )
    ...
    def setupTF(self):
        ...
        modelDir = "D:/Workspace/AutoCorrect/model/HTR/model"
    ...
    def trainBatch(self, batch):
        ...
        rate = (
            ...
            else (0.001 if self.batchesTrained < 10000 else 0.0001)
        )  # decay learning rate
    ...
    def save(self):
        ...
        self.saver.save(
            self.sess,
            "D:\Workspace\AutoCorrect\model\HTR\model\snapshot",
